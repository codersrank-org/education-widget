...
- Create an [issue](https://github.com/codersrank-org/education-widget/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/codersrank-org/education-widget/issues), assuming one does not already exist.
